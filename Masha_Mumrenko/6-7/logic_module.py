...
class Game:
    ...
    @logger_decorator.time_logger_decorator
    @logger_decorator.debug_logger_decorator
    def is_game_ended(self, current_position_status):
        """
    ...
    def reinit(self, reinit_list):
        ...
        name, position, bag, hp = reinit_list[2], reinit_list[3], reinit_list[4], reinit_list[5]
    ...
    def run_game_loop(self):
        ...
        while not is_end:
            ...
            if command == self.managing_commands[0]:
                ...
                files_module.save_game_state(self.game_map.generated_map, self.player.position, map_size, self.player.bag, self.player.hp)
            ...
            is_end = self.is_game_ended(current_cell_status)
