...
class MyGameFlow:
    ...
    def __map_size_input(self):
        ...
        while True:
            ...
            if _map_size >= 5 and _map_size <= 50:
                break
    ...
    def __process_save_game(self):
        ...
        _data_to_save = (self.game_map, self.player)
    ...
    def __process_load_game(self):
        ...
        while True:
            ...
            if os.path.exists(f'{_user_input}.pickle'):
                break
        ...
        if not _loaded_data:
            ...
            self.game_map, self.player = _loaded_data
