...
def define_rows_and_columns(string_len):
    """
...
def split_for_encryption(string, rows_and_colums):
    """
    Splits given string on parts using given rows and columns amounts
...
def encode(normalized_string):
    ...
    rows_and_columns = define_rows_and_columns(len(normalized_string))
    splitted_text = split_for_encryption(normalized_string, rows_and_columns)
...
print(encode(normalized_string))
