...
class DungeonGameMapGenerator:
    ...
    def generate_map(self, map_size):
        ...
        for i in range(traps_number):
            row, column = self.__choose_random_index_and_remove(free_map_cells)
        ...
        player_start_row, player_start_column = self.__choose_random_index_and_remove(free_map_cells)
