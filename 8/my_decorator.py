...
def log_wrapper(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if my_config.is_logging_active:
            log_logger.debug(f'Entered {func.__name__} in {func.__module__} module')     

        to_return = func(*args, **kwargs)

        if my_config.is_logging_active:
            log_logger.debug(f'Exited {func.__name__} in {func.__module__} module')
...
def debug_wrapper(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        if my_config.is_debug_active:

            debug_logger.debug(f'Entered {func.__name__} in {func.__module__} module')
        ...
        if my_config.is_debug_active:
            debug_logger.debug(f'Exited {func.__name__} in {func.__module__} module')
