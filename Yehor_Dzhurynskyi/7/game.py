...
class Game:
    ...
    def __offer_moves(self):
        ...
        up_cell = self.__level.cell_at(self.__level.player.x, self.__level.player.y - 1)
        down_cell = self.__level.cell_at(self.__level.player.x, self.__level.player.y + 1)
        left_cell = self.__level.cell_at(self.__level.player.x - 1, self.__level.player.y)
        right_cell = self.__level.cell_at(self.__level.player.x + 1, self.__level.player.y)
